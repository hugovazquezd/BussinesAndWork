function cambiaGrafica(id) {
    let all_types = ["graficaA", "graficaB", "graficaC"];
...
function load_instagram() {
    let ctx = document.getElementById('graficaA');
    let myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                label: "FOLLOWS",
                backgroundColor: "rgb(129,176,176)",
...
function load_buttons() {
    let ctx = document.getElementById('graficaB');
    let myChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: ["2018", "2019", "2020", "2021", "2022"],
...
function load_twitter() {
    let ctx = document.getElementById('graficaC');
    let myChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: ["2018", "2019", "2020", "2021", "2022"],
